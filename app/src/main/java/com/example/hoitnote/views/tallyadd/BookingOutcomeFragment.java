 ...
 * Use the {@link BookingOutcomeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BookingOutcomeFragment extends Fragment {
     ...
     * @return A new instance of fragment BookingOutcomeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static BookingOutcomeFragment newInstance(String param1, String param2) {
        BookingOutcomeFragment fragment = new BookingOutcomeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        allItemsLinearLayout = (LinearLayout)view.findViewById(R.id.hzs_booking_outcome_all_items);
    ...
    private void classifyButtonInit(View view){
        ...
        final View chooseClassButton = (View) view.findViewById(R.id.hzs_booking_outcome_classify_button);
        ...
        firstClassTextView = (TextView)view.findViewById(R.id.hzs_booking_outcome_first_class);
        secondClassTextView = (TextView)view.findViewById(R.id.hzs_booking_outcome_second_class);
    ...
    private void accountButtonInit(View view){
        final View chooseAccountButton = (View) view.findViewById(R.id.hzs_booking_outcome_account_button);
        final List<String> accountItems = BookingDataHelper.getAccounts();
        accountTextView = (TextView)view.findViewById(R.id.hzs_booking_outcome_account_button);
    ...
    private void timeButtonInit(View view){
        ...
        final View chooseTimeButton = (View) view.findViewById(R.id.hzs_booking_outcome_time_button);
        timeTextView = (TextView)view.findViewById(R.id.hzs_booking_outcome_time_button);
    ...
    private void personButtonInit(View view){
        final View chooseAccountButton = (View) view.findViewById(R.id.hzs_booking_outcome_person_button);
        final List<String> personItems = BookingDataHelper.getPersons();
        personTextView = (TextView)view.findViewById(R.id.hzs_booking_outcome_person_button);
    ...
    private void editTextInit(View view){
        noteEditText = (EditText)view.findViewById(R.id.hzs_booking_outcome_note_button);
        moneyEditText = (EditText)view.findViewById(R.id.hzs_booking_outcome_money_button);
    }
    private void storeButtonInit(View view){
        final View chooseStoreButton = (View) view.findViewById(R.id.hzs_booking_outcome_store_button);
        final List<String> storeItems = BookingDataHelper.getStores();
        storeTextView = (TextView)view.findViewById(R.id.hzs_booking_outcome_store_button);
    ...
    private void projectButtonInit(View view){
        final View chooseProjectButton = (View) view.findViewById(R.id.hzs_booking_outcome_project_button);
        final List<String> projectItems = BookingDataHelper.getProjects();
        projectTextView = (TextView)view.findViewById(R.id.hzs_booking_outcome_project_button);
